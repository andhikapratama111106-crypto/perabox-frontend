...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        console.log('Attempting login with:', { email }); // Mock success log
                            ...
                            <div className="hidden lg:flex flex-col justify-between p-16 bg-primary text-white relative overflow-hidden">
                                ...
                                <div className="relative z-10">
                                    <Link href="/" className="inline-block mb-12">
                                        <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center shadow-lg overflow-hidden border-2 border-white/20 mb-6 mx-auto">
                                            <Image
                                                src="/logo_square.png"
                                                alt="PERABOX Logo"
                                                width={100}
                            ...
                            <div className="p-8 md:p-16 lg:p-20">
                                ...
                                <form onSubmit={handleLogin} className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            <input
                                                ...
                                                className={`w-full px-6 py-4 rounded-[1.25rem] border ${touched.email && errors.email
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="relative group">
                                            <input
                                                ...
                                                className={`w-full px-6 py-4 pr-14 rounded-[1.25rem] border ${touched.password && errors.password
                                                    ? 'border-red-400 bg-red-50/30'
                                                    : 'border-gray-200 focus:border-primary focus:ring-4 focus:ring-primary/10'
                                                    } outline-none transition-all font-medium text-dark`}
                                                placeholder="••••••••"
                                            ...
                                            {touched.password && errors.password && (
                                                <p id="password-error" className="text-xs text-red-500 font-bold mt-1.5 ml-1">{errors.password}</p>
                                            )}
                                        </div>
                                    </div>
                                    ...
                                    <motion.button
                                        ...
                                        className="w-full bg-primary hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed text-white font-extrabold py-4 px-6 rounded-2xl transition-all shadow-xl hover:shadow-2xl active:scale-[0.98] transform hover:-translate-y-0.5"
                                    >
                                        {loading ? (
                                ...
                                <div className="mt-10">
                                    ...
                                    <button
                                        type="button"
                                        className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 border-2 border-gray-100 text-dark font-bold py-3.5 px-6 rounded-2xl transition-all active:scale-[0.98]"
                                    >
