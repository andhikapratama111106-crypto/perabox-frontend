export const homeTranslations = {
    "en": {
        ...
        "bookPage": {
            ...
            "forOrder": "for order",
            "subtitle5": "Complete payment to confirm order",
            ...
            "years": "Years",
            "techNames": {
                "tech-001": "Indra Santoso",
                "tech-002": "Ahmad Rizki",
                "tech-003": "Dedi Kurniawan",
                "tech-004": "Sari Wulandari",
                "tech-005": "Lestari Putri",
                "tech-006": "Dewi Anggraini",
                "tech-007": "Siti Aminah",
                "tech-008": "Andini Wijaya",
                "tech-009": "Bella Subiakto",
                "tech-010": "Hadi Prayitno",
                "tech-011": "Rian Hidayat",
                "tech-012": "Budi Santoso"
            },
            "map": {
            ...
            "techBios": {
                "tech-001": "Air conditioning system specialist with BNSP certification. Prioritizes accuracy and efficiency in every job.",
                "tech-002": "Expert in AC unit disassembly and assembly for residential and office buildings with professional standards.",
                "tech-003": "Master of routine AC maintenance techniques to keep it energy-efficient and provide maximum cooling.",
                "tech-004": "Very thorough in comprehensive AC unit cleaning to ensure the air produced is clean and healthy.",
                "tech-005": "Extensive experience handling various technical issues on split and inverter type AC units.",
                "tech-006": "Focuses on preventive maintenance to extend the life of your AC unit with neat workmanship.",
                "tech-007": "AC routine maintenance specialist who guarantees every corner of the unit is cleaned perfectly and germ-free.",
                "tech-008": "Ensures your AC freon pressure is always optimal for efficient cooling and electricity saving.",
                "tech-009": "Reliable technician for diagnosing and repairing electronic module damage in modern AC units.",
                "tech-010": "Expert in new AC unit installation with aesthetic pipe arrangement and guaranteed performance.",
                "tech-011": "Senior AC technician who prioritizes customer satisfaction through honest and transparent work.",
                "tech-012": "Highly dedicated technician who is always ready to provide the right solution for AC cooling issues."
            },
            "qris": {
                "title": "QRIS Payment",
                "subtitle": "Scan code to complete order",
                ...
                "btnPaid": "I Have Paid",
                "verifying": "Verifying...",
                "btnBack": "Back to Order Details",
                "qrCodeSimulated": "Simulated QR Code",
                "instruction": "QR Code can be scanned using GoPay, OVO, Dana, LinkAja, BCA Mobile & other banking apps.",
                "notDetected": "Payment not detected. Please try again after paying.",
                "error": "Verification error. Please try again."
            },
            "wa": {
                "direct": "DIRECT (NOW)",
                "emergency": "(EMERGENCY)",
                "newOrder": "Hello PERABOX, I have a new order",
                "service": "Service",
                "time": "Time",
                "location": "Location",
                "notes": "Notes",
                "estTotal": "Estimated Total",
                "confirm": "Please confirm. Thank you.",
                "summaryHeader": "[BOOKING VIA APP]",
                "summaryTech": "Technician",
                "summaryAddon": "Additional Services",
                "summaryPay": "Payment Method",
                "summaryNotes": "User Notes",
                "emergencyPrefix": "*NEED EMERGENCY SERVICE*",
                "confirmTransfer": "want to confirm transfer",
                "totalTransfer": "Total Transfer",
                "uniqueCode": "Unique Code",
                "statusEmergency": "STATUS: EMERGENCY / ASAP",
                "proofInstruction": "Here is my proof of transfer (attach photo):"
            }
        },
        "loginPage": {
            "title": "Welcome Home!",
    ...
    "id": {
        ...
        "bookPage": {
            ...
            "subtitle5": "Selesaikan pembayaran untuk konfirmasi pesanan",
            ...
            "backToHome": "Kembali ke Beranda",
            "redirectingToPay": "Mengarahkan ke pembayaran...",
            ...
            "techBios": {
                "tech-001": "Spesialis sistem pendingin udara dengan sertifikasi BNSP. Mengutamakan ketepatan dan efisiensi dalam setiap pengerjaan.",
                "tech-002": "Ahli dalam pengerjaan bongkar pasang unit AC untuk hunian maupun gedung perkantoran dengan standar profesional.",
                "tech-003": "Menguasai teknik perawatan rutin unit AC agar tetap hemat energi dan memberikan kesejukan maksimal.",
                "tech-004": "Sangat teliti dalam pembersihan menyeluruh unit AC untuk memastikan udara yang dihasilkan bersih dan sehat.",
                "tech-005": "Berpengalaman luas dalam menangani berbagai kendala teknis pada unit AC tipe split maupun inverter.",
                "tech-006": "Fokus pada perawatan preventif untuk memperpanjang usia pakai unit AC Anda dengan pengerjaan yang rapi.",
                "tech-007": "Spesialis perawatan rutin AC yang menjamin setiap sudut unit dibersihkan dengan sempurna dan bebas kuman.",
                "tech-008": "Memastikan tekanan freon AC Anda selalu optimal untuk pendinginan yang efisien dan hemat listrik.",
                "tech-009": "Teknisi handal untuk mendiagnosa dan memperbaiki kerusakan modul elektronik pada unit AC modern.",
                "tech-010": "Ahli dalam instalasi unit AC baru dengan penataan pipa yang estetik dan performa yang terjamin.",
                "tech-011": "Senior teknisi AC yang mengutamakan kepuasan pelanggan melalui pengerjaan yang jujur dan transparan.",
                "tech-012": "Teknisi berdedikasi tinggi yang selalu siap memberikan solusi tepat untuk masalah AC yang kurang dingin."
            },
            "qris": {
                "title": "Pembayaran QRIS",
                "subtitle": "Scan kode untuk selesaikan pesanan",
                "loading": "Menyiapkan QR Code...",
                "total": "Total Pembayaran",
                "finishIn": "Selesaikan dalam",
                "paymentId": "ID Pembayaran",
                "btnPaid": "Saya Sudah Bayar",
                "verifying": "Memverifikasi...",
                "btnBack": "Kembali ke Detail Pesanan",
                "qrCodeSimulated": "QR Code Simulasi",
                "instruction": "Kode QR dapat dipindai menggunakan GoPay, OVO, Dana, LinkAja, BCA Mobile & aplikasi perbankan lainnya.",
                "notDetected": "Pembayaran belum terdeteksi. Silakan coba lagi setelah membayar.",
                "error": "Kesalahan verifikasi. Silakan coba lagi."
            },
            "wa": {
                "direct": "LANGSUNG (SEKARANG)",
                "emergency": "(DARURAT)",
                "newOrder": "Halo PERABOX, saya ada order baru",
                "service": "Layanan",
                "time": "Waktu",
                "location": "Lokasi",
                "notes": "Catatan",
                "estTotal": "Total Estimasi",
                "confirm": "Mohon konfirmasinya. Terima kasih.",
                "summaryHeader": "[BOOKING VIA APLIKASI]",
                "summaryTech": "Teknisi",
                "summaryAddon": "Layanan Tambahan",
                "summaryPay": "Metode Bayar",
                "summaryNotes": "Catatan User",
                "emergencyPrefix": "*PERLU LAYANAN DARURAT*",
                "confirmTransfer": "ingin konfirmasi transfer",
                "totalTransfer": "Total Transfer",
                "uniqueCode": "Kode Unik",
                "statusEmergency": "STATUS: DARURAT / ASAP",
                "proofInstruction": "Berikut bukti transfer saya (lampirkan foto):"
            }
        },
        "loginPage": {
    ...
    "es": {
        ...
        "bookPage": {
            ...
            "forOrder": "para el pedido",
            "subtitle5": "Complete el pago para confirmar el pedido",
            ...
            "backToHome": "Volver al Inicio",
            "redirectingToPay": "Redirigiendo al pago...",
            "payError": "El pago falló. Por favor, inténtelo de nuevo.",
            "btnNext": "Siguiente",
            ...
            "years": "Años",
            "techNames": {
                "tech-001": "Juan Santos",
                "tech-002": "Ahmad Rizki",
                "tech-003": "Diego Hernández",
                "tech-004": "Sarah Moreno",
                "tech-005": "Lucía Pérez",
                "tech-006": "Diana García",
                "tech-007": "Sofía Martínez",
                "tech-008": "Andrea Vargas",
                "tech-009": "Isabel Blanco",
                "tech-010": "Hugo Ortiz",
                "tech-011": "Ricardo Gómez",
                "tech-012": "Bruno Díaz"
            },
            "map": {
            ...
            "techBios": {
                "tech-001": "Especialista en sistemas de aire acondicionado con certificación BNSP. Prioriza la precisión y la eficiencia.",
                "tech-002": "Experto en desmontaje y montaje de unidades de AC para edificios residenciales y oficinas con estándares profesionales.",
                "tech-003": "Maestro en técnicas de mantenimiento de rutina de AC para mantener el ahorro de energía y el máximo enfriamiento.",
                "tech-004": "Muy minucioso en la limpieza integral de unidades de AC para asegurar un aire limpio y saludable.",
                "tech-005": "Amplia experiencia manejando diversos problemas técnicos en unidades de AC tipo split e inverter.",
                "tech-006": "Se enfoca en el mantenimiento preventivo para extender la vida útil de su unidad de AC con un trabajo impecable.",
                "tech-007": "Especialista en mantenimiento de rutina de AC que garantiza una limpieza perfecta y libre de gérmenes.",
                "tech-008": "Asegura que la presión de freón de su AC sea siempre óptima para un enfriamiento eficiente y ahorro de energía.",
                "tech-009": "Técnico confiable para diagnosticar y reparar daños en módulos electrónicos en unidades de AC modernas.",
                "tech-010": "Experto en instalación de nuevas unidades de AC con disposición estética de tuberías y rendimiento garantizado.",
                "tech-011": "Técnico senior de AC que prioriza la satisfacción del cliente a través de un trabajo honesto y transparente.",
                "tech-012": "Técnico altamente dedicado que siempre está listo para brindar la solución adecuada a problemas de enfriamiento."
            },
            "qris": {
                "title": "Pago QRIS",
                "subtitle": "Escanea el código para completar el pedido",
                "loading": "Preparando código QR...",
                "total": "Pago Total",
                "finishIn": "Terminar en",
                "paymentId": "ID de Pago",
                "btnPaid": "He Pagado",
                "verifying": "Verificando...",
                "btnBack": "Volver a Detalles del Pedido",
                "qrCodeSimulated": "Código QR Simulado",
                "instruction": "El código QR se puede escanear con GoPay, OVO, Dana, LinkAja, BCA Mobile y otras aplicaciones bancarias.",
                "notDetected": "Pago no detectado. Inténtelo de nuevo después de pagar.",
                "error": "Error de verificación. Inténtelo de nuevo."
            },
            "wa": {
                "direct": "DIRECTO (AHORA)",
                "emergency": "(EMERGENCIA)",
                "newOrder": "Hola PERABOX, tengo un nuevo pedido",
                "service": "Servicio",
                "time": "Hora",
                "location": "Ubicación",
                "notes": "Notas",
                "estTotal": "Total Estimado",
                "confirm": "Por favor confirme. Gracias.",
                "summaryHeader": "[RESERVA VÍA APP]",
                "summaryTech": "Técnico",
                "summaryAddon": "Servicios Adicionales",
                "summaryPay": "Método de Pago",
                "summaryNotes": "Notas del Usuario",
                "emergencyPrefix": "*NECESITO SERVICIO DE EMERGENCIA*",
                "confirmTransfer": "quiero confirmar la transferencia",
                "totalTransfer": "Transferencia Total",
                "uniqueCode": "Código Único",
                "statusEmergency": "ESTADO: EMERGENCIA / ASAP",
                "proofInstruction": "Aquí está mi comprobante de transferencia (adjuntar foto):"
            }
        },
        "loginPage": {
    ...
    "ja": {
        ...
        "bookPage": {
            ...
            "paymentBCA": "BCA銀行振込",
            "transferTotal": "転送合計",
            "transferNote": "*自動照合のため、必ず{code}（下3桁）まで正確に送金してください",
            "accountNumber": "口座番号",
            "copy": "コピー",
            "accountName": "口座名義",
            ...
            "forOrder": "注文番号",
            "subtitle5": "注文を確定するためにお支払いを完了してください",
            "orderReceived": "注文を承りました！",
            ...
            "backToHome": "ホームに戻る",
            "redirectingToPay": "お支払いページにリダイレクト中...",
            "payError": "お支払いに失敗しました。もう一度お試しください。",
            "btnNext": "次へ",
            "experienceLabel": "経験",
            "currencySymbol": "Rp",
            "currencyCode": "ja-JP",
            ...
            "techBios": {
                "tech-001": "BNSP認定の空調システムスペシャリスト。すべての作業において正確さと効率を優先します。",
                "tech-002": "住宅およびオフィスビルのプロフェッショナルな基準でのエアコンユニットの分解・組み立ての専門家。",
                "tech-003": "エネルギー効率を維持し、最大限の冷却を提供するための定期的なエアコンメンテナンス技術のマスター。",
                "tech-004": "クリーンで健康的な空気を確保するため、包括的なエアコンユニットのクリーニングにおいて非常に徹底しています。",
                "tech-005": "スプリット型およびインバーター型のエアコンユニットに関するさまざまな技術的問題を扱った豊富な経験。",
                "tech-006": "丁寧な仕上がりでエアコンユニットの寿命を延ばすための予防メンテナンスに焦点を当てています。",
                "tech-007": "ユニットの隅々まで完璧に、そして除菌して清掃することを保証するエアコン定期メンテナンススペシャリスト。",
                "tech-008": "効率的な冷却と節電のために、エアコンのフロン圧力を常に最適に保つことを確実にします。",
                "tech-009": "最新のエアコンユニットの電子モジュールの故障を診断し、修理するための信頼できる技術者。",
                "tech-010": "審美的な配管配置と性能保証を備えた、新しいエアコンユニット設置の専門家。",
                "tech-011": "誠実で透明性のある作業を通じて顧客満足を優先するシニアエアコン技術者。",
                "tech-012": "エアコンの冷却問題に対して常に適切な解決策を提供する準備ができている献身的な技術者。"
            },
            "qris": {
                "title": "QRIS決済",
                "subtitle": "コードをスキャンして注文を完了してください",
                "loading": "QRコードを準備中...",
                "total": "お支払い合計",
                "finishIn": "残り時間",
                "paymentId": "お支払いID",
                ...
                "verifying": "認証中...",
                "btnBack": "注文詳細に戻る",
                "qrCodeSimulated": "シミュレートされたQRコード",
                "instruction": "QRコードはGoPay、OVO、Dana、LinkAja、BCA Mobile、その他の銀行アプリでスキャンできます。",
                "notDetected": "支払いが検出されませんでした。支払い後にもう一度お試しください。",
                "error": "認証エラー。もう一度やり直してください。"
            },
            "wa": {
                "direct": "即時（今すぐ）",
                "emergency": "（緊急）",
                "newOrder": "PERABOX様、新しい注文があります",
                "service": "サービス",
                "time": "時間",
                "location": "場所",
                "notes": "備考",
                "estTotal": "見積合計",
                "confirm": "確認をお願いします。ありがとうございます。",
                "summaryHeader": "【アプリ経由の予約】",
                "summaryTech": "技術者",
                "summaryAddon": "追加サービス",
                "summaryPay": "支払い方法",
                "summaryNotes": "ユーザー備考",
                "emergencyPrefix": "*緊急サービスが必要*",
                "confirmTransfer": "送金の確認をしたい",
                "totalTransfer": "送金合計",
                "uniqueCode": "ユニークコード",
                "statusEmergency": "ステータス：緊急 / 至急",
                "proofInstruction": "送金証明はこちらです（写真を添付）："
            }
        },
        "loginPage": {
            "title": "おかえりなさい！",
    ...
    "zh": {
        ...
        "bookPage": {
            ...
            "techBios": {
                "tech-001": "拥有BNSP认证的空调系统专家。在每项工作中优先考虑准确性和效率。",
                "tech-002": "具备住宅及办公楼空调单元拆装专业标准的专家。",
                "tech-003": "精通定期空调维护技术，保持节能并提供最大制冷效果。",
                "tech-004": "在全面的空调单元清洁方面非常彻底，确保产生的空气清新健康。",
                "tech-005": "在处理分体式和变频式空调单元的各种技术问题方面拥有丰富经验。",
                "tech-006": "专注于预防性维护，以精细的操作延长空调单元的使用寿命。",
                "tech-007": "定期空调维护专家，保证单元的每个角落都清洁完美且无菌。",
                "tech-008": "确保您的空调氟利昂压力始终处于最佳状态，以实现高效制冷和节电。",
                "tech-009": "诊断和修复现代空调单元电子模块损坏的可靠技术员。",
                "tech-010": "新空调单元安装专家，具备美观的管道排列和保证的性能。",
                "tech-011": "高级空调技术员，通过诚实透明的工作优先考虑客户满意度。",
                "tech-012": "高度敬业的技术员，随时准备为空调制冷问题提供正确的解决方案。"
            },
            "qris": {
                "title": "QRIS支付",
                "subtitle": "扫描代码完成订单",
                ...
                "verifying": "正在验证...",
                "btnBack": "返回订单详情",
                "qrCodeSimulated": "模拟二维码",
                "instruction": "二维码可以使用 GoPay、OVO、Dana、LinkAja、BCA Mobile 等银行应用扫描。",
                "notDetected": "未检测到付款。请付款后重试。",
                "error": "验证错误。请重试。"
            },
            "wa": {
                "direct": "立即（现在）",
                "emergency": "（紧急）",
                "newOrder": "您好 PERABOX，我有一个新订单",
                "service": "服务",
                "time": "时间",
                "location": "位置",
                "notes": "备注",
                "estTotal": "预计总额",
                "confirm": "请确认。谢谢。",
                "summaryHeader": "【通过应用预订】",
                "summaryTech": "技术员",
                "summaryAddon": "附加服务",
                "summaryPay": "付款方式",
                "summaryNotes": "用户备注",
                "emergencyPrefix": "*需要紧急服务*",
                "confirmTransfer": "想要确认转账",
                "totalTransfer": "转账总额",
                "uniqueCode": "唯一代码",
                "statusEmergency": "状态：紧急 / 尽快",
                "proofInstruction": "这是我的转账凭证（见附件照片）："
            }
        },
        "loginPage": {
            "title": "欢迎回来！",
