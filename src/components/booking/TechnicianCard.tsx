...
export const TechnicianCard: React.FC<TechnicianCardProps> = ({ technician, onSelect, selected, priority = false }) => {
    ...
    return (
        <div
            ...
            className={`group relative bg-white rounded-[2rem] p-4 cursor-pointer transition-all duration-500 border-2 overflow-hidden h-full flex flex-col
                ${selected
            ...
            <div className="flex-none">
                ...
                {technician.experience && (
                    <span className="text-[10px] text-primary font-bold uppercase tracking-widest mt-1 block">
                        {technician.experience.replace(/[^0-9]/g, '')} {t('bookPage.years') || 'Tahun'} {experienceLabel}
                    </span>
                )}
            </div>
